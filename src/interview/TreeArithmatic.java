...
public class TreeArithmatic 
{
	...
	public static void main(String[] args)
	{
		...
		//   *     *
		//  12 3   4  5
		Tree5 myTree = new Tree5("+");
		myTree.left = new Tree5("*");	myTree.right = new Tree5("*");
		myTree.left.left = new Tree5("12");	myTree.left.right = new Tree5("3");
		myTree.right.left = new Tree5("4");	myTree.right.right = new Tree5("5");
		compute(myTree);
	...
	public static int computerWithoutstack(Tree5 myTree)
	{
	...
	public static void compute(Tree5 myTree)
	{
