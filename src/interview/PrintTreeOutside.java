...
public class PrintTreeOutside {
	public static void main(String[] args) {
		 ...
		 */
		BinaryTree7 myTree = new BinaryTree7(1);
		myTree.left = new BinaryTree7(2);
		myTree.right = new BinaryTree7(3);
		myTree.left.left = new BinaryTree7(4);
		myTree.left.right = new BinaryTree7(5);
		myTree.right.left = new BinaryTree7(6);
		myTree.right.right = new BinaryTree7(7);
...
class BinaryTree7 {
	...
	private boolean ifLeaf(BinaryTree7 myT) {
