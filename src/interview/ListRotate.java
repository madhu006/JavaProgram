...
class ListRotate 
{
	...
	{
		List6 myList = new List6(1);
		myList.next = new List6(2);
		myList.next.next = new List6(3);
		myList.next.next.next = new List6(4);
		myList.next.next.next.next = new List6(5);//so the list is 1,2,3,4,5
	...
	public static List6 RotateN(List6 myL, int k)//myL is the original list and k is number of rotates
	{
		...
		List6 current = myL;//we start from my list head
		List6 oldTail;
		List6 newStart;
