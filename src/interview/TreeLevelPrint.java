...
public class TreeLevelPrint {
	...
	public static void PrintTreeLevel(Tree3 t, int desire)//no need to keep track current level for queue method
	{
		...
		while(!trees.isEmpty())
		{
			Tree3 temp = trees.poll();//poll method is same as the conceptual deque() method
